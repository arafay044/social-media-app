...
export const useGetReacentPosts = () => {
  return useQuery({
    queryKey: [QUERY_KEYS.GET_RECENT_POSTS],
...
export const useGetPost = () => {
  return useInfiniteQuery({
    ...
    getNextPageParam: (lastPage: any) => {
      ...
      return lastPage.documents[lastPage.documents.length - 1].$id; // string cursor
    },
    initialPageParam: undefined, // <-- FIX: required when using getNextPageParam
  });
};
